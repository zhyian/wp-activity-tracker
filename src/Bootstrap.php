...
use Zhyian\ActivityTracker\Exceptions\NotReadableFileException;
...
final class Bootstrap {
	...
	/**
	 * @throws NotReadableFileException Thrown when the constants.php or
	 *                                  config.php file is not readable.
	 */
	...
	private function run( string $file = null ): void {
		 ...
		 * @param Plugin $plugin
		 */
		do_action( 'wp_activity_tracker_loaded', $plugin );
	}
